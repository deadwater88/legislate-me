...
class Bill(models.Model):
    ...
    sponsor = models.CharField(max_length=1000, blank=True)
    title = models.CharField(max_length=5000)
    chamber = models.CharField(max_length=1000)
    ...
    bill_id = models.CharField(default="", max_length=500, db_column="bill_id")
    img_id = models.IntegerField(default=0)
    check = models.CharField(default="", blank=True, max_length=50)
    leg_name = models.CharField(default= "",max_length=500, null=True)
    leg_id = models.CharField(default= "", max_length= 500, null=True)
